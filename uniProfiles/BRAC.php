...
<head>
    ...
    <title>BRAC University Bangladesh Profile</title>
            ...
            <div class="col-md-12 sections ms-sm-auto">
                ...
                <section id="rankings">
                    ...
                    <div class="ranking-list">
                        ...
                        <ul>
                            <li>Ranked among the Top Universities in [Country]</li>
                            <li>Recognized for Excellence in [Subject/Area] Studies</li>
                            <li>Ranked #1 in [Specific Field/Area] Research</li>
                        </ul>
                    </div>
                </section>
                ...
                <section id="admission">
                    ...
                    <ul>
                        ...
                        <li>BRAC University Admission Test scores</li>
