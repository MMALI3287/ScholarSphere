...
<head>
    ...
    <title>United International University Profile</title>
...
<body>
    ...
    <nav class="sidebar">
        <div class="position-sticky">
            <ul class="nav flex-column">
                ...
                <hr>
                <li class="nav-item">
                    <a class="nav-link" href="#programs">Academic Programs</a>
                </li>
                <hr>
                <li class="nav-item">
    ...
    <div class="header">
        <div class="row">
            ...
            <div class="col-md-2"><img src="../assets/images/uiu.jpg" alt="UIU"></div>
        </div>
    </div>
            ...
            <div class="col-md-12 sections ms-sm-auto">
                ...
                <section id="rankings">
                    ...
                    <div class="ranking-list">
                        ...
                        <ul>
                            ...
                            <li>Recognized for Excellence in [Subject/Area]</li>
                            <li>Highly Regarded for Industry Collaboration and Innovation</li>
                        </ul>
                    </div>
                </section>
                ...
                <section id="admission">
                    ...
                    <ul>
                        ...
                        <li>UIU Admission Test scores</li>
