...
<head>
    ...
    <title>Rajshahi University Profile</title>
    ...
    <nav class="bg-dark sidebar">
        <div class="position-sticky">
            <ul class="nav flex-column">
                ...
                <hr>
                <li class="nav-item">
                    <a class="nav-link" href="#faculty">Faculties and Departments</a>
                </li>
                <hr>
                <li class="nav-item">
    ...
    <div class="header">
        <div class="row">
            <div class="col-md-10">
                ...
                <p>Empowering Excellence in Education and Research</p>
            </div>
            <div class="col-md-2"><img src="../assets/images/ru.jpg" alt="RU"></div>
        </div>
    </div>
            ...
            <div class="col-md-9 sections ms-sm-auto">
                ...
                <section id="rankings">
                    ...
                    <div class="ranking-list">
                        ...
                        <ul>
                            ...
                            <li>Recognized for Research Excellence in [Subject/Area]</li>
                            <li>Highly Regarded for Cultural and Historical Significance</li>
                        </ul>
                    </div>
                </section>
                ...
                <section id="admission">
                    ...
                    <ul>
                        ...
                        <li>RU Admission Test scores</li>
