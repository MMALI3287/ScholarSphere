                ...
                <div class="col-md-5 login-form">
                    <form class="row" method="post" action="register.php">
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="username" class="form-control" id="inputUserName4" value="<?php echo $username; ?>">
                        </div>
                        <div class="col-md-12 mb-4">
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="password" class="form-control" id="inputPassword4" value="<?php echo $password; ?>">
                        </div>
                        <div class="col-md-12">
