...
<body>
    ...
    $query = "SELECT * FROM forum_posts WHERE category_id = '$selectedCategory' AND subcategory_id = '$selectedSubcategory'";
    ...
    <div class="container mt-5">
        <h2 class="text-center">Posts under <?php echo $selectedCategoryName; ?></h2>
        <div class="row">
            <?php
            // Display posts
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="card mb-4">
                <div class="card-body">
                <h5 class="card-title"><a href="postDetail.php?post_id=' . $row['post_id'] . '" class="text-decoration-none">' . $row['title'] . '</a></h5>
    ...
    <?php
    include 'partials/_footer.php'; // Include your footer
    ?>
